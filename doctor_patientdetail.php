...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['prescription'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        header("Location: doctor_patientdetail.php?id=$id");
        exit();
    } else {
    ...
    <div class="right-column">
        ...
        <form action="" method="POST">
            <div class="form-group">
                <label for="prescription"><i class="fas fa-pencil-alt"></i> Prescription:</label>
...
<div class="back-container">
    <a href="doctor_dashboard.php" class="back"><i class="fas fa-arrow-left"></i> Back to Dashboard</a>
</div>
